# <img src="assets/TAMARILLO_THETA.svg" alt="tamarillo theta" width="78" height="78" align="absmiddle"> theta-spec
...
> **[theta](https://theta.tamarillo.ai/)** is the default implementation of this spec — a Rust CLI that resolves, locks, and casts `theta.toml` to any supported harness.
...
Most of the spec is read-self-explanatory for anyone familiar with agent harnesses. A detailed and exhaustive description of each one of the defining fields can be found [condensed here](docs/spec/manifest.md) and also [in the manifest section of this doc](docs/manifest/index.md).
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for how to propose spec changes, request new harnesses, and the TEP process.

### Style

Check [STYLE.md](STYLE.md) for documentation conventions.
